public class App {
    ...
    public static void main(String[] args) {
        ...
        int numberOfGreenApples =
                countApplesByColor(apples, "green");
    ...
    static int countApplesByColor(Apple [] apples,
                                  String color){
        int amount = 0;
        //TODO
        return amount;
    ...
    static int countApplesByWeight(Apple [] apples,
                                   int weight,
                                   String operator){
        int amount = 0;
        for(Apple a : apples) {
